...
Es gelten die Grenzwerte \citep{wcag}:

\begin{equation}
  	L_c(c_1, c_2) \geq
	\begin{cases}
		3.0, \text{Schriftgroesse} \geq 18pt \lor yo \\
	\end{cases}
\end{equation}
